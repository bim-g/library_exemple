...
class BoxMessage
{
    ...
    static function success($val)
    {
        ...
        switch ($val) {
            case 1:
                $message = array('type' => 'success Save', 'text' => 'Register with success');
                break;
            case 2:
                $message = array('type' => 'success Update', 'text' => 'Update with success');
                break;
            case 3:
                $message = array('type' => 'success Delete', 'text' => 'Delete with success');
                break;
            case 4:
                $message = array('type' => 'found', 'text' => 'Result found');
                break;
            case 5:
                $message = array('type' => 'Success', 'text' => 'Operation Success');
                break;
        }
        return $message;
    }
